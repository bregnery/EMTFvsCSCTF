...
# Access Histograms
Hist = data.Get("matchCSCTFtrackPtHist")
...
axisHist = root.TH2F("axisHist","Matched CSCTF Tracks P_{T}",1,xMin,xMax,1,yMin,yMax)
...
Hist.Draw("hist same")
canvas.SaveAs("Hist_matchCSCTFtrackPt.png")
