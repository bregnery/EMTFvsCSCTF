...
# Access Histograms
Hist = data.Get("matchEMTFtrackModeHist")
...
axisHist = root.TH2F("axisHist","Matched EMTF Tracks Mode",1,xMin,xMax,1,yMin,yMax)
...
Hist.Draw("hist same")
canvas.SaveAs("Hist_matchEMTFtrackMode.png")
