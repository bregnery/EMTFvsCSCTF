...
# Access Histograms
Hist = data.Get("matchCSCTFtrackEtaHist")
...
axisHist = root.TH2F("axisHist","Matched CSCTF Tracks #eta",1,xMin,xMax,1,yMin,yMax)
...
Hist.Draw("hist same")
canvas.SaveAs("Hist_matchCSCTFtrackEta.png")
