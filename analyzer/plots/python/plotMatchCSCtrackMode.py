...
# Access Histograms
Hist = data.Get("matchCSCTFtrackModeHist")
...
axisHist = root.TH2F("axisHist","Matched CSCTF Tracks Mode",1,xMin,xMax,1,yMin,yMax)
...
Hist.Draw("hist same")
canvas.SaveAs("Hist_matchCSCTFtrackMode.png")
