...
# Access Histograms
Hist = data.Get("matchEMTFtrackEtaHist")
...
axisHist = root.TH2F("axisHist","Matched EMTF Tracks #eta",1,xMin,xMax,1,yMin,yMax)
...
Hist.Draw("hist same")
canvas.SaveAs("Hist_matchEMTFtrackEta.png")
